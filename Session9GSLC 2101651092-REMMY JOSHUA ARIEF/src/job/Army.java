package job;
//class Army child dari class IndonesiaNationalArmy
import java.util.concurrent.ThreadLocalRandom;

public class Army extends IndonesiaNationalArmy {

	
	public Army(String name, int stamina, int intelligence, int skill, int strategy, int power) {
		super(name, stamina, intelligence, skill, strategy, power, power);
	...
	public void training() {
		...
		int num = ThreadLocalRandom.current().nextInt(0,7);
		String w = null;
