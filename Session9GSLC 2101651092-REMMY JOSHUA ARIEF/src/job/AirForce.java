package job;
//class AirForce child dari class IndonesiaNationalArmy
import java.util.concurrent.ThreadLocalRandom;

public class AirForce extends IndonesiaNationalArmy {

	


	public AirForce(String name, int stamina, int intelligence, int skill, int strategy, int powerTeam) {
	...
	public void training() {
		...
		case 4:{
			w = "is training shooting,swim and fly plane";
			break;
		}
		case 5:{
